...
export default function Header({ hostIdentity, hostName, imageUrl, isFollowing, name, viewerIdentity }: HeaderProps) {
...
export const HeaderSkeleton = () => {
    return (
        <div className="mt-2 flex flex-col lg:flex-row gap-y-4 lg:gap-y-0 items-start justify-between px-4">
            <div className="flex items-center gap-x-2">
